...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println(123 * 456);
        System.out.println(123 / 10); // 123을 10으로 나눈 몫 값
        System.out.println(123 % 10); // 123을 10으로 나누고 나온 나머지 값
        ...
        System.out.println('a' / 2.0);
        System.out.println('a' % 2.0);
        // 실수가 연산에 들어가게 된다면 실수를 죽일 수 없기에 결과 값은 실수로 나온다.
...
//        System.out.println("hello" % "world");
        ...
        // 문자열 + 정수, 실수, 문자, 논리가 들어가게 된다면 모두 문자열로 취급된다.
