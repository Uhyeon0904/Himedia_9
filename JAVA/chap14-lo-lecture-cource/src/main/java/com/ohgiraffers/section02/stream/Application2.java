...
public class Application2 {
    public static void main(String[] args) {
        ...
        FileReader fr = null;
        try {
            fr = new FileReader("src/com/ohgiraffers/section02/stream/testReader");
            int value;
...
//            }
            ...
            char[] carr = new char[(int) new File("src/com/ohgiraffers/section02" +
                    // File의 반환형은 long 타입 이기 때문에 int 형으로 형변환
                    "/stream/testReader").length()];
            fr.read(carr);
