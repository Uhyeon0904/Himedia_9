...
public class ServiceMethodTestServlet extends HttpServlet {
    ...
    *   나중에 service method의 인자 타입은 변경하지 않고 다른 프로토콜을 사용한 Request로 변경이 가능하다.(다형성) */
    @Override
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        /*  현재 사용 되는 프로토콜을 HTTP 프로토콜로, HttpServletRequest 타입이다.
        *   HttpServletRequest는 ServletRequest를 상속 받아 구현했으며, HTTP 플토콜의 정보를 담고 있으므로
